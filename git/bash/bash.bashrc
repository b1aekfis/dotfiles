...
# the command to setup a shell prompt theme for Bash with Oh My Posh engine:
...
eval "$(oh-my-posh init bash --config C:/Users/QUI/.dotfiles/omp/themes/b1aekfis-stdHfHp.omp.json)"
